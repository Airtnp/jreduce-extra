...
public class NopHierarchy extends Hierarchy {
    ...
    public void resolveToNativeCall(final NopMethodVisitor mv,
    ...
    public void resolveToStubCall(final NopMethodVisitor mv, final InlineClassMethod stub,
                                  final int opcode, final String owner, final String name, final String desc,
                                  final boolean initial) {
        if (initial) {
    ...
    public void resolveToInlineCall(final NopMethodVisitor mv,
                                    final int opcode, final String owner, final String name, final String desc,
                                    final boolean initial) {
        if (initial) {
    ...
    public void generateInlineReplacement(final NopMethodVisitor mv,
    ...
    public void resolveAllCall(final NopMethodVisitor mv, final HashSet<Integer> closure,
                               final int opcode, final String owner, final String name, final String desc,
                               final boolean initial) {
    ...
    public void resolveStubCall(final NopMethodVisitor mv, final HashSet<Integer> closure,
                                final int opcode, final String owner, final String name, final String desc,
                                final boolean initial) {
        final CallInfo callInfo = new CallInfo(opcode, owner, name, desc, null);
